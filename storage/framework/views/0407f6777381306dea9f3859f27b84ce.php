            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="date"
                            ...
                            class="form-control"
                            value="<?php echo e(\Carbon\Carbon::parse($order->tanggal_pemesanan)->format('Y-m-d')); ?>"
                            required>
                ...
                <div class="mb-3">
                    ...
                    <select name="tipe_order" class="form-select" id="tipeOrder" required>
                        <option value="custom" <?php echo e($order->tipe_order == 'custom' ? 'selected' : ''); ?>>
                            Custom
                        </option>
                        <option value="lembaran" <?php echo e($order->tipe_order == 'lembaran' ? 'selected' : ''); ?>>
                            Lembaran
                        </option>
                    </select>
                </div>
