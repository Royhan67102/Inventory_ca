                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($design->file_hasil): ?>
                                    <a href="<?php echo e(asset('storage/' . $design->file_hasil)); ?>" target="_blank">Lihat Hasil</a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <a href="<?php echo e(route('designs.edit', $design->order_id)); ?>" class="btn btn-sm btn-warning">Update</a>
                                <a href="<?php echo e(route('designs.show', $design->id)); ?>" class="btn btn-sm btn-info">Detail</a>
                            </td>
                        </tr>
