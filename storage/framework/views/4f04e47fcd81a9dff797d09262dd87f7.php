    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if(in_array($role, ['admin','tim_desain','tim_produksi'])): ?>
                    <li class="nav-item">
                ...
                <?php if(in_array($role, ['admin','tim_produksi','tim_desain','driver1'])): ?>
                    <li class="nav-item">
                ...
                <?php if(in_array($role, ['admin','driver','driver1','tim_desain'])): ?>
                    <li class="nav-item">
                ...
                <?php if(in_array($role, ['admin','logistik','tim_desain'])): ?>
                    <li class="nav-item">
